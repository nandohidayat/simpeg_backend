...
class Absen extends Command
{
     ...
     * @var string
     */
    protected $description = 'Get all the absen boys';
        ...
        foreach ($ip_key as $ip => $key) {
            ...
            if ($Connect) {
                ...
                for ($a = 0; $a < count($buffer); $a++) {
                    ...
                    if ($PIN != 0) {
                        $data = Presensi::create(['pin' => $PIN, 'datetime' => $DateTime, 'verified' => $Verified, 'status' => $Status]);
                    }
                }
            }
        }
